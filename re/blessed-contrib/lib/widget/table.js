...
function Table(options) {
  ...
  options.bold = true;
  options.selectedFg = options.style.selected.fg || 'white';
  options.selectedBg = options.style.selected.bg || 'blue';
  options.fg = options.style.fg || 'green';
  options.bg = options.style.bg || '';
...
Table.prototype.select = function(i){
  this.rows.select(i)
};
